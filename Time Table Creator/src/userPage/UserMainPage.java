...
public class UserMainPage extends JFrame implements ActionListener{
	...
	public UserMainPage(JFrame obj,String username) 
	{
		...
		panel.setBounds(557, 310, 318, 295);
		homePage.add(panel);
		...
		panel_1.setBounds(49, 110, 455, 92);
		...
		panel_2.setBounds(48, 213, 455, 392);
		homePage.add(panel_2);
		panel_2.setLayout(null);
		
		JLabel fnameL = new JLabel("Full Name : ");
		fnameL.setBounds(10, 11, 123, 19);
		panel_2.add(fnameL);
		...
		update.setBounds(66, 326, 123, 32);
		...
		delete.setBounds(205, 326, 158, 32);
		...
		chgPass.setBounds(600, 273, 233, 26);
	...
	private void createAdminServices() {
			...
			panel_3.setBounds(557, 147, 304, 105);
			...
			handover.setBounds(588, 110, 233, 26);
